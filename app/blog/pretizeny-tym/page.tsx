          ...
          <main className="min-h-screen bg-slate-950 text-white px-5 py-16">
                <div className="max-w-2xl mx-auto">
                        <nav className="mb-8 text-sm text-slate-500">
                          ...
                          {" / "}
                                  <span className="text-slate-400">Pretizeny tym</span>span>
                        </nav>nav>
                        ...
                        <p className="text-slate-400 text-sm mb-8">13. kvetna 2026 &bull; 6 minut cteni</p>p>
                        ...
                        <div className="prose prose-invert max-w-none space-y-6 text-slate-300 leading-relaxed">
                                  ...
                                  <ol className="list-decimal list-inside space-y-3 ml-2">
                                              <li><strong className="text-white">Prodluzujici se dodaci casy</strong>strong> — ukoly, ktere drive trvaly 2 dny, najednou trvaji 5.</li>li>
                                              <li><strong className="text-white">Narustajici pocet chyb</strong>strong> — drobne, ale caste. Preklepy, zapomente informace, chybejici podrobnosti.</li>li>
                                              <li><strong className="text-white">Kratsi odpovedi v komunikaci</strong>strong> — kde driv psal odstavce, pise ted jednu vetu.</li>li>
                                              <li><strong className="text-white">Zapomine na schuzky nebo prichazi nepripraveny</strong>strong> — kognitivni kapacita je vyerpana.</li>li>
                                              <li><strong className="text-white">Zvysene cerpani dovolene nebo nemocenska</strong>strong> — organismus se zacina branil.</li>li>
                                              <li><strong className="text-white">Odmitani novych ukolu</strong>strong> — u lidi, kteri drive brali vsechno.</li>li>
                                              <li><strong className="text-white">Pokles aktivity na spolecnych platformach</strong>strong> — Slack, Teams, porady.</li>li>
                                  </ol>ol>
                                  ...
                                  <p>
                                              Presne toto ukazuje <Link href="/#zjisteni" className="text-blue-400 hover:text-blue-300">firemni rentgen</Link>Link> —
